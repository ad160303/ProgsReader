package com.hw.progsreader.utils;
...
public class FileArrayAdapter extends ArrayAdapter<Option> {
    ...
    public FileArrayAdapter(Context context, int resourceId, List<Option> objs){
        ...
        if (o != null){
            ...
            if (o.getData().equalsIgnoreCase("folder")){
                ...
                if (name.endsWith(".xls") || name.endsWith(".xlsx"))
                    ...
                    im.setImageResource(R.drawable.java32);
                else
